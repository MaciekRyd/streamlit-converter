# Funkcja do konwersji temperatury między różnymi jednostkami
# Parametry:
#   value: wartość temperatury do konwersji (liczba)
#   from_unit: jednostka źródłowa (string: "Celsius", "Fahrenheit", "Kelvin")
#   to_unit: jednostka docelowa (string: "Celsius", "Fahrenheit", "Kelvin")
# Zwraca: skonwertowaną wartość temperatury (liczba)
def convert_temperature(value, from_unit, to_unit):
    # Sprawdź czy jednostki są takie same - jeśli tak, zwróć wartość bez zmian
